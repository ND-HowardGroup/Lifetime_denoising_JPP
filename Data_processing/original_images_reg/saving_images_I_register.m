...
addpath('/Users/varunmannam/Desktop/Spring20/Research_S20/Jan20/1101/BPAE_sample4/original_images_reg/I_stack');
%addpath('/Users/varunmannam/Desktop/Spring20/Research_S20/Jan20/1101/BPAE_sample4/registration');

s1 = 'W800_P200_4mW_Ax1_I_t';
ip =zeros(512,512);
lower_I = 0;
upper_I = 5e-3;
...
for i=1:images
    ...
    s5 = strcat(s4,s3);
    ip = imread(s5);
    ip1 = mat2gray(ip,[lower_I,upper_I]);
